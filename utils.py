...
def higienizar_nome_arquivo(nome_original: str) -> str:
    ...
    # Substitui os caracteres proibidos por uma string vazia (remove-os)
    nome_limpo = re.sub(padrao_proibido, '', nome_original)
    
    # Remove espaços extras nas pontas e retorna

    # Remove espaços duplos criados após a remoção dos caracteres
